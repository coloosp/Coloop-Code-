...
[](https://io.zouht.com/154.html)1 前言
=====================================
...
[](https://io.zouht.com/154.html)2 常用容器
=======================================

[](https://io.zouht.com/154.html)2.1 内容总览
-----------------------------------------
...
*   字符串
    ...
    *   \[x\] **string** (basic\_string\\<char\\>)
*   对与元组
    
    *   \[x\] **pair**
    *   \[ \] **tuple**

[](https://io.zouht.com/154.html)2.2 向量 [vector](https://zh.cppreference.com/w/cpp/container/vector)
----------------------------------------------------------------------------------------------------
...
### [](https://io.zouht.com/154.html)2.2.1 常用方法

#### [](https://io.zouht.com/154.html)构造
...
#### [](https://io.zouht.com/154.html)尾接 & 尾删
...
#### [](https://io.zouht.com/154.html)中括号运算符

和一般数组一样的作用

时间复杂度：$O(1)$

#### [](https://io.zouht.com/154.html)获取长度
...
#### [](https://io.zouht.com/154.html)清空
...
#### [](https://io.zouht.com/154.html)判空
...
#### [](https://io.zouht.com/154.html)改变长度
...
### [](https://io.zouht.com/154.html)2.2.2 适用情形
...
### [](https://io.zouht.com/154.html)2.2.3 注意事项

#### [](https://io.zouht.com/154.html)提前指定长度
...
#### [](https://io.zouht.com/154.html)当心 size\_t 溢出
...
[](https://io.zouht.com/154.html)2.3 栈 [stack](https://zh.cppreference.com/w/cpp/container/stack)
-------------------------------------------------------------------------------------------------
...
### [](https://io.zouht.com/154.html)2.3.1 常用方法
...
[](https://io.zouht.com/154.html)2.4 队列 [queue](https://zh.cppreference.com/w/cpp/container/queue)
--------------------------------------------------------------------------------------------------
...
### [](https://io.zouht.com/154.html)2.4.1 常用方法
...
### [](https://io.zouht.com/154.html)2.4.2 适用情形

如果不卡常的话，就可以直接用它而不需要手写队列了。

### [](https://io.zouht.com/154.html)2.4.3 注意事项
...
[](https://io.zouht.com/154.html)2.5 优先队列 [priority\_queue](https://zh.cppreference.com/w/cpp/container/priority_queue)
-----------------------------------------------------------------------------------------------------------------------
...
### [](https://io.zouht.com/154.html)2.5.1 常用方法
...
#### [](https://io.zouht.com/154.html)其他
...
### [](https://io.zouht.com/154.html)2.5.2 适用情形
...
### [](https://io.zouht.com/154.html)2.5.3 注意事项

#### [](https://io.zouht.com/154.html)仅堆顶可读
...
#### [](https://io.zouht.com/154.html)所有元素不可写
...
[](https://io.zouht.com/154.html)2.6 集合 [set](https://zh.cppreference.com/w/cpp/container/set)
----------------------------------------------------------------------------------------------
...
| 集合三要素 | 解释 | set | multiset | unordered\_set |
| --- | --- | --- | --- | --- |
| 确定性 | 一个元素要么在集合中，要么不在 | ✔ | ✔ | ✔ |
| 互异性 | 一个元素仅可以在集合中出现一次 | ✔ | ❌（任意次） | ✔ |
| 无序性 | 集合中的元素是没有顺序的 | ❌（从小到大） | ❌（从小到大） | ✔ |

### [](https://io.zouht.com/154.html)2.6.1 常用方法
...
#### [](https://io.zouht.com/154.html)遍历
...
### [](https://io.zouht.com/154.html)2.6.2 适用情形

*   元素去重：$\[1,1,3,2,4,4\]\\to\[1,2,3,4\]$
*   维护顺序：$\[1,5,3,7,9\]\\to\[1,3,5,7,9\]$
*   元素是否出现过：元素大小 $\[-10^{18},10^{18}\]$，元素数量 $10^6$，vis 数组无法实现，通过 set 可以完成。

### [](https://io.zouht.com/154.html)2.6.3 注意事项

#### [](https://io.zouht.com/154.html)不存在下标索引
...
#### [](https://io.zouht.com/154.html)元素只读
...
#### [](https://io.zouht.com/154.html)不可用迭代器计算下标
...
[](https://io.zouht.com/154.html)2.7 映射 [map](https://zh.cppreference.com/w/cpp/container/map)
----------------------------------------------------------------------------------------------
...
| 性质 | 解释 | map | multimap | unordered\_map |
| --- | --- | --- | --- | --- |
| 互异性 | 一个键仅可以在映射中出现一次 | ✔ | ❌（任意次） | ✔ |
| 无序性 | 键是没有顺序的 | ❌（从小到大） | ❌（从小到大） | ✔ |

### [](https://io.zouht.com/154.html)2.7.1 常用方法
...
### [](https://io.zouht.com/154.html)2.7.2 适用情形

需要维护映射的场景可以使用：输入若干字符串，统计每种字符串的出现次数。(`map<string, int> mp`)

### [](https://io.zouht.com/154.html)2.7.3 注意事项

#### [](https://io.zouht.com/154.html)中括号访问时默认值
...
[](https://io.zouht.com/154.html)2.8 字符串 [string](https://zh.cppreference.com/w/cpp/string)
-------------------------------------------------------------------------------------------
...
### [](https://io.zouht.com/154.html)2.8.1 常用方法
...
#### [](https://io.zouht.com/154.html)输入输出
...
#### [](https://io.zouht.com/154.html)数值与字符串互转（C++11）

| 源 | 目的 | 函数 |
| --- | --- | --- |
| int / long long / float / double / long double | string | to\_string() |
| string | int | stoi() |
...
### [](https://io.zouht.com/154.html)2.8.2 适用情形

非常好用！~建议直接把字符数组扔了，赶快投入 string 的怀抱。~

### [](https://io.zouht.com/154.html)2.8.3 注意事项

#### [](https://io.zouht.com/154.html)尾接字符串一定要用 `+=`
...
#### [](https://io.zouht.com/154.html)`.substr()` 方法的奇葩参数

一定要注意，C++ string 的取子串的第一个参数是**子串起点下标**，第二个参数是**子串长度**。

第二个参数不是子串终点！不是子串终点！要与 java 等其他语言区分开来。

#### [](https://io.zouht.com/154.html)`.find()` 方法的复杂度

该方法实现为暴力实现，时间复杂度为 $O(n^2)$.

~不要幻想 STL 内置了个 $O(n)$ 的 KMP 算法~

[](https://io.zouht.com/154.html)2.9 二元组 [pair](https://zh.cppreference.com/w/cpp/utility/pair)
-----------------------------------------------------------------------------------------------
...
### [](https://io.zouht.com/154.html)2.9.1 常用方法
...
#### [](https://io.zouht.com/154.html)赋值
...
#### [](https://io.zouht.com/154.html)取值
...
#### [](https://io.zouht.com/154.html)判同
...
### [](https://io.zouht.com/154.html)2.9.2 适用场景

所有需要二元组的场景均可使用，效率和自己定义结构体差不多。

### [](https://io.zouht.com/154.html)2.9.3 注意事项

无

[](https://io.zouht.com/154.html)3 迭代器简介
========================================

[](https://io.zouht.com/154.html)3.1 迭代器是什么？
--------------------------------------------
...
[](https://io.zouht.com/154.html)3.2 为何需要迭代器？
---------------------------------------------
...
[](https://io.zouht.com/154.html)3.3 迭代器用法
------------------------------------------
...
[](https://io.zouht.com/154.html)3.4 常见问题
-----------------------------------------
...
[](https://io.zouht.com/154.html)4 常用算法
=======================================

[](https://io.zouht.com/154.html)4.1 内容总览
-----------------------------------------
...
[](https://io.zouht.com/154.html)4.2 `swap()`
---------------------------------------------
...
[](https://io.zouht.com/154.html)4.3 `sort()`
---------------------------------------------
...
[](https://io.zouht.com/154.html)4.4 `lower_bound()` / `upper_bound()`
----------------------------------------------------------------------
...
[](https://io.zouht.com/154.html)4.5 `reverse()`
------------------------------------------------
...
[](https://io.zouht.com/154.html)4.6 `max()` / `min()`
------------------------------------------------------
...
[](https://io.zouht.com/154.html)4.7 `unique()`
-----------------------------------------------
...
[](https://io.zouht.com/154.html)4.8 数学函数
-----------------------------------------
...
> 原文地址：[https://codeforces.com/blog/entry/107717](https://codeforces.com/blog/entry/107717)
...
*   $\\lfloor\\log\_2 a\\rfloor$
    
    *   别用：`log2(a)`
    *   要用：`__lg` （不规范，但是这是竞赛）/ `bit_width`（C++20 可用）

[](https://io.zouht.com/154.html)4.9 `gcd()` / `lcm()`
------------------------------------------------------
...
*   [1 前言](about:blank#cl-1)
*   [2 常用容器](about:blank#cl-2)
    *   [2.1 内容总览](about:blank#cl-3)
    *   [2.2 向量 vector](about:blank#cl-4)
        *   [2.2.1 常用方法](about:blank#cl-5)
            *   [构造](about:blank#cl-6)
            *   [尾接 & 尾删](about:blank#cl-7)
            *   [中括号运算符](about:blank#cl-8)
            *   [获取长度](about:blank#cl-9)
            *   [清空](about:blank#cl-10)
            *   [判空](about:blank#cl-11)
            *   [改变长度](about:blank#cl-12)
        *   [2.2.2 适用情形](about:blank#cl-13)
        *   [2.2.3 注意事项](about:blank#cl-14)
            *   [提前指定长度](about:blank#cl-15)
            *   [当心 size\_t 溢出](about:blank#cl-16)
    *   [2.3 栈 stack](about:blank#cl-17)
        *   [2.3.1 常用方法](about:blank#cl-18)
        *   [2.3.2 适用情形](about:blank#cl-19)
        *   [2.3.3 注意事项](about:blank#cl-20)
    *   [2.4 队列 queue](about:blank#cl-21)
        *   [2.4.1 常用方法](about:blank#cl-22)
        *   [2.4.2 适用情形](about:blank#cl-23)
        *   [2.4.3 注意事项](about:blank#cl-24)
    *   [2.5 优先队列 priority\_queue](about:blank#cl-25)
        *   [2.5.1 常用方法](about:blank#cl-26)
            *   [构造](about:blank#cl-27)
            *   [其他](about:blank#cl-28)
        *   [2.5.2 适用情形](about:blank#cl-29)
        *   [2.5.3 注意事项](about:blank#cl-30)
            *   [仅堆顶可读](about:blank#cl-31)
            *   [所有元素不可写](about:blank#cl-32)
    *   [2.6 集合 set](about:blank#cl-33)
        *   [2.6.1 常用方法](about:blank#cl-34)
            *   [构造](about:blank#cl-35)
            *   [遍历](about:blank#cl-36)
            *   [其他](about:blank#cl-37)
        *   [2.6.2 适用情形](about:blank#cl-38)
        *   [2.6.3 注意事项](about:blank#cl-39)
            *   [不存在下标索引](about:blank#cl-40)
            *   [元素只读](about:blank#cl-41)
            *   [不可用迭代器计算下标](about:blank#cl-42)
    *   [2.7 映射 map](about:blank#cl-43)
        *   [2.7.1 常用方法](about:blank#cl-44)
            *   [构造](about:blank#cl-45)
            *   [遍历](about:blank#cl-46)
            *   [其他](about:blank#cl-47)
        *   [2.7.2 适用情形](about:blank#cl-48)
        *   [2.7.3 注意事项](about:blank#cl-49)
            *   [中括号访问时默认值](about:blank#cl-50)
            *   [不可用迭代器计算下标](about:blank#cl-51)
    *   [2.8 字符串 string](about:blank#cl-52)
        *   [2.8.1 常用方法](about:blank#cl-53)
            *   [构造](about:blank#cl-54)
            *   [输入输出](about:blank#cl-55)
            *   [其他](about:blank#cl-56)
            *   [数值与字符串互转（C++11）](about:blank#cl-57)
        *   [2.8.2 适用情形](about:blank#cl-58)
        *   [2.8.3 注意事项](about:blank#cl-59)
            *   [尾接字符串一定要用 +=](about:blank#cl-60)
            *   [.substr() 方法的奇葩参数](about:blank#cl-61)
            *   [.find() 方法的复杂度](about:blank#cl-62)
    *   [2.9 二元组 pair](about:blank#cl-63)
        *   [2.9.1 常用方法](about:blank#cl-64)
            *   [构造](about:blank#cl-65)
            *   [赋值](about:blank#cl-66)
            *   [取值](about:blank#cl-67)
            *   [判同](about:blank#cl-68)
        *   [2.9.2 适用场景](about:blank#cl-69)
        *   [2.9.3 注意事项](about:blank#cl-70)
*   [3 迭代器简介](about:blank#cl-71)
    *   [3.1 迭代器是什么？](about:blank#cl-72)
    *   [3.2 为何需要迭代器？](about:blank#cl-73)
    *   [3.3 迭代器用法](about:blank#cl-74)
    *   [3.4 常见问题](about:blank#cl-75)
*   [4 常用算法](about:blank#cl-76)
    *   [4.1 内容总览](about:blank#cl-77)
    *   [4.2 swap()](about:blank#cl-78)
    *   [4.3 sort()](about:blank#cl-79)
    *   [4.4 lower\_bound() / upper\_bound()](about:blank#cl-80)
    *   [4.5 reverse()](about:blank#cl-81)
    *   [4.6 max() / min()](about:blank#cl-82)
    *   [4.7 unique()](about:blank#cl-83)
    *   [4.8 数学函数](about:blank#cl-84)
    *   [4.9 gcd() / lcm()](about:blank#cl-85)
...
标签: [C++](https://io.zouht.com/tag/C/), [STL](https://io.zouht.com/tag/STL/), [语法](https://io.zouht.com/tag/%E8%AF%AD%E6%B3%95/)

本文采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.zh) 许可，本文 Markdown 源码：[Haotian-BiJi](https://github.com/ChrisKimZHT/Haotian-BiJi)

  

本文转自 [https://io.zouht.com/154.html](https://io.zouht.com/154.html)，如有侵权，请联系删除。